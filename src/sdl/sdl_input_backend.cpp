...
static int gamepadbutton_to_button(Uint8 button) {
	switch (button) {
		...
		case SDL_CONTROLLER_BUTTON_A: case SDL_CONTROLLER_BUTTON_B: case SDL_CONTROLLER_BUTTON_LEFTSHOULDER: return 4;
		case SDL_CONTROLLER_BUTTON_X: case SDL_CONTROLLER_BUTTON_Y: case SDL_CONTROLLER_BUTTON_RIGHTSHOULDER: return 5;
